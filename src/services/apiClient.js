...
// 1. Read the base URL from the .env file (supports both Vite and Create React App)
const API_URL = import.meta.env.VITE_API_BASE_URL || process.env.REACT_APP_API_BASE_URL || 'http://127.0.0.1:8000';

const apiClient = axios.create({
    // 2. Inject the dynamic URL into the baseURL
